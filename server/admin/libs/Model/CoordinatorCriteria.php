...
require_once("DAO/CoordinatorCriteriaDAO.php");

/**
 * The CoordinatorCriteria class extends CoordinatorDAOCriteria and is used
 ...
 * @version 1.0
 */
class CoordinatorCriteria extends CoordinatorCriteriaDAO
{
