...
require_once("DAO/AttendanceCriteriaDAO.php");

/**
 * The AttendanceCriteria class extends AttendanceDAOCriteria and is used
 ...
 * @version 1.0
 */
class AttendanceCriteria extends AttendanceCriteriaDAO
{
