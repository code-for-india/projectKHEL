...
require_once("DAO/BeneficiaryCriteriaDAO.php");

/**
 * The BeneficiaryCriteria class extends BeneficiaryDAOCriteria and is used
 ...
 * @version 1.0
 */
class BeneficiaryCriteria extends BeneficiaryCriteriaDAO
{
