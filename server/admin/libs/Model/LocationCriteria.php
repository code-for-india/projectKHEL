...
require_once("DAO/LocationCriteriaDAO.php");

/**
 * The LocationCriteria class extends LocationDAOCriteria and is used
 ...
 * @version 1.0
 */
class LocationCriteria extends LocationCriteriaDAO
{
